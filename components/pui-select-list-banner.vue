<template>
	...
	<view class="">
		...
		<view class="gui-list-image" v-if="checkedType == 'ring' && !item.checked">
			<view class="gui-list-image border-gray-10 gui-bg-gray gui-color-black gui-h3 text-center gui-flex gui-justify-content-center gui-align-items-center">
			<text >{{item.number}}</text>
			</view>
		</view>
		<view class="gui-list-image" v-if="checkedType == 'ring' && item.checked">
			<view class="gui-list-image border-orange-10 gui-bg-orange1 gui-color-white gui-h3  text-center gui-flex gui-justify-content-center gui-align-items-center" >
				<text >{{item.number}}</text>
			</view>
		</view>
				...
				<view class="gui-select-list-content gui-flex gui-column gui-align-items-center">
							...
							<view class="gui-lr-margin">
								...
								<!-- <text class="gui-list-body-desc gui-color-gray">评分{{item.score}}</text> -->
								<!-- <input type="text" class="gui-list-body-desc gui-color-gray" placeholder="评分" :value="item.score" /> -->
							</view>
