<template>
	<view class="gui-flex gui-rows gui-wrap gui-space-between">
		...
		:style="{
			...
			<view>
				<gui-image :src="item.Pic" :width="(375 - margin*2)" :height="imgHeight"></gui-image>
			</view>
			<view class="gui-product-lines">
				<text class="gui-product-name">{{item.CourseTitle}}</text>
			</view>
			<view class="gui-product-lines gui-flex gui-rows gui-nowrap gui-align-items-center">
				...
				<text class="gui-h5 gui-color-red">{{item.Fee}}</text>
