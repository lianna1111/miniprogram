	...
	ref="guiPage" :customFooter="true">
		<view slot="gBody" class="gui-flex1 gui-flex gui-columns">
			...
			<view class="gui-form-item gui-border-b">
				<text class="gui-form-label"><text class="gui-color-red">*</text>考次名称</text>
				<view class="gui-form-body">
					<input type="text" class="gui-form-input" 
					v-model="formData.Title" name="Title" placeholder="请输入考次名称" />
				</view>
			</view>
			...
			<view class="gui-form-item gui-border-b">
				...
				<view class="gui-form-body">
					<input type="text" class="gui-form-input"
					v-model="formData.StartTime" name="StartTime" placeholder="请输入开始时间" />
				</view>	
			...
			<view class="gui-form-item gui-border-b">
				...
				<view class="gui-form-body">
					<input type="text" class="gui-form-input"
					v-model="formData.EndTime" name="EndTime" placeholder="请输入结束时间" />
				</view>
			</view>
			<!-- <view class="gui-form-item gui-border-b">
				<text class="gui-form-label"><text class="gui-color-red">*</text>考官ID</text>
				<view class="gui-form-body">
					<input type="number" class="gui-form-input" 
					v-model="formData.ExaminerID" name="ExaminerID" placeholder="请输入考官ID" />
				</view>
			</view> -->
...
export default {
	...
	methods: {
		...
		// 提交
		submit:function () { 
			if(!this.formData.Title||!this.formData.StartTime
			...
			uni.request({
			    url: this.domain + 'exam/add_examtime', //提交表单
				method:'post',
			    data: this.formData,
