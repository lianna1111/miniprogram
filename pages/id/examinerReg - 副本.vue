			...
			:style="{height:mainHeight+'px'}">
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						...
						v-model="formData.username" name="username" placeholder="请输入考官用户名" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.NickName" name="NickName" placeholder="请输入考官昵称" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.RealName" name="RealName" placeholder="请输入考官真实姓名" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					<text class="gui-form-label"><text class="gui-color-red">*</text>考官号</text>
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.StudentCode" name="StudentCode" placeholder="请输入考官号" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					<text class="gui-form-label">所属机构</text>
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.InstituteID" name="InstituteID" placeholder="请输入所属机构编号" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					<text class="gui-form-label"><text class="gui-color-red">*</text>考官照片</text>
					...
					<!-- <view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.Headimg" name="Headimg" placeholder="请输入考官头像" />
					</view> -->
				</view>
				 <view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.Mobile" name="Mobile" placeholder="请输入考官手机号码" />
					</view>
				</view> 
				<view class="gui-form-item gui-border-b">
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						...
						v-model="formData.Age" name="Age" placeholder="请输入考官年龄" />
					</view>
				</view>
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="number" class="gui-form-input" 
						v-model="formData.Height" name="Height" placeholder="请输入考官身高(单位:mm)" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="number" class="gui-form-input" 
						v-model="formData.Weight" name="Weight" placeholder="请输入考官体重(单位:g)" />
					</view>
				</view>
				...
				<view class="gui-padding" v-if="step == 3">
					...
					<view class="gui-form-item gui-border-b gui-margin-top-large">
						...
						<view class="gui-form-body">
							<input type="text" class="gui-form-input"  @blur="birthDay" maxlength="18"
							v-model="formData.TeacherNumber" name="TeacherNumber" placeholder="请输入资格证号码" />
						</view>
					</view>
					<view class="gui-margin-top-large">
...
export default {
	data() {
		return {
			...
			step: 1,// 步骤
			Gender : ['请选择考官性别', '女', '男'],//piker：性别
			GenderIndex : 0,//pickerindex
			Blood : ['请选择考官血型', 'A', 'B', 'AB', 'O'],//piker：血型
	...
	methods: {
		 	...
		 	uni.chooseImage({
		 		...
		 		success: (chooseImageRes) => {
		 			...
		 			const uploadTask = uni.uploadFile({
		 				url : 'https://api.yiwenyw.com/upload/path/user/examiner',
		...
		selectImg1(){
			...
			uni.chooseImage({
				...
				success: (chooseImageRes) => {
					...
					//图片上传
					const uploadTask = uni.uploadFile({
						url : this.domain+'upload/path/user/examiner',
						filePath: tempFilePaths[0],
						name: 'file',
						success: function (uploadFileRes) {
							var data = JSON.parse(uploadFileRes.data);
		...
		submit:function () {
			...
			// 请根据实际需求进行数据校验及提交
			if(!this.formData.TeacherNumber||!this.formData.Certification) 
			{uni.showToast({title:"必填项请填写完整", icon:"none"});
			return}
			else{
				//性别
				...
				else {uni.showToast({title:"请选择考官性别", icon:"none"});}
				//血型
			...
			uni.request({
			    url: 'https://api.yiwenyw.com/user/add', //提交表单
				method:'post',
			    data: this.formData,
			    ...
			    success: (res) => {
					if(res.data.errno==0){
						...
						console.log(res,"res")
						uni.setStorageSync('isExaminer',true);//??
						uni.setStorageSync('utype', '1');
						uni.switchTab({
