			...
			:style="{height:mainHeight+'px'}">
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						...
						v-model="formData.username" name="UserName" placeholder="请输入教师用户名(4-16位,无特殊符号)" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.NickName" name="NickName" placeholder="请输入教师昵称" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.RealName" name="RealName" placeholder="请输入教师真实姓名" />
					</view>
				</view>
			
				<view class="gui-form-item gui-border-b">
					<text class="gui-form-label"><text class="gui-color-red">*</text>教师照片</text>
			...
			uni.request({
			    ...
			    success: (res) => {
					if(res.data.errno==0){
						...
						console.log(res,"res")
						uni.setStorageSync('isTeacher',true);//
						uni.setStorageSync('utype', '2');
						uni.switchTab({
