			...
			:style="{height:mainHeight+'px'}">
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						...
						v-model="formData.username" name="UserName" placeholder="请输入摄影师用户名(4-16位,无特殊符号)" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.NickName" name="NickName" placeholder="请输入摄影师昵称" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.RealName" name="RealName" placeholder="请输入摄影师真实姓名" />
					</view>
				</view>
			
				<view class="gui-form-item gui-border-b">
					<text class="gui-form-label"><text class="gui-color-red">*</text>摄影师照片</text>
					...
					<!-- <view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.Headimg" name="Headimg" placeholder="请输入摄影师头像" />
					</view> -->
				</view>
				 <view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="text" class="gui-form-input" 
						v-model="formData.Mobile" name="Mobile" placeholder="请输入摄影师手机号码" />
					</view>
				</view> 
				<view class="gui-form-item gui-border-b">
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						...
						v-model="formData.Age" name="Age" placeholder="请输入摄影师年龄" />
					</view>
				</view>
				...
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="number" class="gui-form-input" 
						v-model="formData.Height" name="Height" placeholder="请输入摄影师身高(单位:mm)" />
					</view>
				</view>
				<view class="gui-form-item gui-border-b">
					...
					<view class="gui-form-body">
						<input type="number" class="gui-form-input" 
						v-model="formData.Weight" name="Weight" placeholder="请输入摄影师体重(单位:g)" />
					</view>
				</view>
...
export default {
	data() {
		return {
			...
			step: 1,// 步骤
			Gender : ['请选择摄影师性别', '女', '男'],//piker：性别
			GenderIndex : 0,//pickerindex
			Blood : ['请选择摄影师血型', 'A', 'B', 'AB', 'O'],//piker：血型
	...
	methods: {
		 	...
		 	uni.chooseImage({
		 		...
		 		success: (chooseImageRes) => {
		 			...
		 			const uploadTask = uni.uploadFile({
		 				url : that.domain+'upload/path/user/teacher',
		...
		submit:function () {
			...
			return}
				...
				else {uni.showToast({title:"请选择摄影师性别", icon:"none"});}
				//血型
			...
			uni.request({
			    ...
			    success: (res) => {
					if(res.data.errno==0){
						...
						console.log(res,"res")
						uni.setStorageSync('isPhotograph',true);//
